            ...
            <form action="{{ route('admin.property.update', $property->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nama_gedung" class="form-control" value="{{ $property->nama_gedung }}">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="area_id" class="form-select">
                            ...
                            <option value="bangunan"
                                {{ $property->area_id == 'bangunan' ? 'selected' : '' }}>
                                Bangunan
                            </option>

                            <option value="tanah_kosong"
                                {{ $property->area_id == 'tanah_kosong' ? 'selected' : '' }}>
                                Tanah Kosong
                            </option>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="luas_tanah" class="form-control" value="{{ $property->luas_tanah }}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label>Luas Gedung</label>
                        <input type="text" name="luas_gedung" class="form-control" value="{{ $property->luas_gedung }}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label>Status Tanah</label>
                        <input type="text" name="status_tanah" class="form-control" value="{{ $property->status_tanah }}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label>Penggunaan Saat Ini</label>
                        <input type="text" name="penggunaan_saat_ini" class="form-control" value="{{ $property->penggunaan_saat_ini }}">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="lebar_jalan" class="form-control" value="{{ $property->lebar_jalan }}">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="titik_koordinat" class="form-control" value="{{ $property->titik_koordinat }}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label>Space Idle Gedung</label>
                        <input type="text" name="space_idle_gedung" class="form-control" value="{{ $property->space_idle_gedung }}">
                    </div>
